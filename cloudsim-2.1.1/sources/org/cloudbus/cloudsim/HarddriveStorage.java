...
public class HarddriveStorage implements Storage {
    ...
    private List<PhysicalFile> fileList;
     ...
     */
    private void init() {
        fileList = new ArrayList<PhysicalFile>();
     ...
     * found using {@link gridsim.datagrid.PhysicalFile#getTransactionTime()}.
     *
     ...
     */
    @Override
	public double addReservedFile(PhysicalFile file) {
        if (file == null) {
            return 0;
        }
	...
	public boolean hasPotentialAvailableSpace(int fileSize) {
        ...
        Iterator<PhysicalFile> it = fileList.iterator();
     ...
     */
    @Override
	public PhysicalFile getFile(String fileName) {
        // check first whether file name is valid or not
        PhysicalFile obj = null;
     ...
     */
    private boolean isFileValid(PhysicalFile file, String methodName) {
     ...
     */
    @Override
	public double addFile(PhysicalFile file) {
        double result = 0.0;
     ...
     */
    @Override
	public double addFile(List<PhysicalFile> list) {
        double result = 0.0;
        ...
        Iterator<PhysicalFile> it = list.iterator();
        PhysicalFile file = null;
        while (it.hasNext()) {
            file = it.next();
     ...
     */
    @Override
	public PhysicalFile deleteFile(String fileName) {
        if (fileName == null || fileName.length() == 0) {
            return null;
        }
     ...
     */
    @Override
	public double deleteFile(String fileName, PhysicalFile file) {
     ...
     */
    @Override
	public double deleteFile(PhysicalFile file) {
        double result = 0.0;
        // check if the file is valid or not
     ...
     */
    @Override
	public boolean contains(PhysicalFile file) {
        boolean result = false;
     ...
     */
    @Override
	public boolean renameFile(PhysicalFile file, String newName) {
        ...
        PhysicalFile obj = getFile(file.getName());
        if (obj == null) {
        	return result;
        } else {
        	obj.setName(newName);
