...
public interface Storage {
     ...
     */
    double addReservedFile(PhysicalFile file);
     ...
     */
    PhysicalFile getFile(String fileName);
     ...
     */
    double addFile(PhysicalFile file);
     ...
     */
    double addFile(List<PhysicalFile> list);
     ...
     */
    PhysicalFile deleteFile(String fileName);
     ...
     */
    double deleteFile(String fileName, PhysicalFile file);
     ...
     * @return the time taken (in seconds) for deleting the specified file
     */
    double deleteFile(PhysicalFile file);
     ...
     * otherwise
     */
    boolean contains(PhysicalFile file);
     ...
     * otherwise
     */
    boolean renameFile(PhysicalFile file, String newName);
