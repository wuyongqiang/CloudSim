...
public class CoinsEnergy {
  ...
  public static void makeChangeForAmount(int a_targetChangeAmount,
    ...
    FitnessFunction myFunc =
        new DcEnergyFitnessFunction(a_targetChangeAmount, a_maxWeight);
//    conf.setFitnessFunction(myFunc);
    ...
    System.out.println("\t" + DcEnergyFitnessFunction.getNumberOfCoinsAtGene(
    ...
    System.out.println("For a total of "
                       + DcEnergyFitnessFunction.amountOfChange(
        bestSolutionSoFar)
                       + " cents in "
                       + DcEnergyFitnessFunction.getTotalNumberOfCoins(
        bestSolutionSoFar)
                       + " coins with a total weight of "
                       + DcEnergyFitnessFunction.getTotalWeight(
        bestSolutionSoFar)
                       + ")");
  }
