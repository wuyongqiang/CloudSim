 ...
 * cloudlet on it.
 */
public class CopyOfCloudSimExample1 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			int id1 = 1;
			Cloudlet cloudlet1 = new Cloudlet(id1, length, pesNumber, fileSize, outputSize, utilizationModel, utilizationModel, utilizationModel);
