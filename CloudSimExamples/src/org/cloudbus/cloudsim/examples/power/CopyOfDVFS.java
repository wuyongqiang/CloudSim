...
public class CopyOfDVFS {
	...
	public static void main(String[] args) {
		...
		String rsltFile = "C:\\Users\\n7682905\\Software\\cloudsim-2.1.1\\SimResults\\result.txt";
		try {
			FileOutputStream fos = new FileOutputStream(rsltFile);
			Log.setOutput(fos);
			Log.setDisabled(false);
		} catch (FileNotFoundException e1) {
			Log.printLine("FileNotFoundException "+ rsltFile);
			e1.printStackTrace();
			return;
		}
