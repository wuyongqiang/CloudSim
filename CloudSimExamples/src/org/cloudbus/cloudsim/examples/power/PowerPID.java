...
import org.cloudbus.cloudsim.power.PowerVmAllocationPolicyPID;
...
public class PowerPID extends SingleThreshold {
	...
	protected static PowerDatacenter createDatacenter(String name) throws Exception {
		...
		try {
			powerDatacenter = new PowerDatacenter(
					name,
					characteristics,
					new PowerVmAllocationPolicyPID(hostList, utilizationThreshold,utilizationLowThreshold),
